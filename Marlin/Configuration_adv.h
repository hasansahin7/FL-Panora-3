...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 15*60, 15*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Panora Commands"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Open Mic. Lamp"
  #define MAIN_MENU_ITEM_1_GCODE "M42 P0 S255"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Close Mic. Lamp " 
  #define MAIN_MENU_ITEM_2_GCODE "M42 P0 S0" 
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Open 2. Lamp " 
  #define MAIN_MENU_ITEM_3_GCODE "M42 P69 S255" 
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Close 2. Lamp " 
  #define MAIN_MENU_ITEM_4_GCODE "M42 P69 S0" 
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Open 3. Lamp" 
  #define MAIN_MENU_ITEM_5_GCODE "M42 P16 S255" 
  //#define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "Close 3. Lamp" 
  #define MAIN_MENU_ITEM_6_GCODE "M42 P16 S0" 
  //#define MAIN_MENU_ITEM_6_CONFIRM

  #define MAIN_MENU_ITEM_7_DESC "Open Lamp Fan"
  #define MAIN_MENU_ITEM_7_GCODE "M106 P0" 
  //#define MAIN_MENU_ITEM_7_CONFIRM

  #define MAIN_MENU_ITEM_8_DESC "Close Lamp Fan"
  #define MAIN_MENU_ITEM_8_GCODE "M107 P0" 
  //#define MAIN_MENU_ITEM_8_CONFIRM

  #define MAIN_MENU_ITEM_9_DESC "Open 2. Fan"
  #define MAIN_MENU_ITEM_9_GCODE "M106 P1"
  //#define MAIN_MENU_ITEM_9_CONFIRM

  #define MAIN_MENU_ITEM_10_DESC "Close 2. Fan"
  #define MAIN_MENU_ITEM_10_GCODE "M107 P1"
  //#define MAIN_MENU_ITEM_10_CONFIRM

  #define MAIN_MENU_ITEM_11_DESC "Relative Mode"
  #define MAIN_MENU_ITEM_11_GCODE "G91"
  //#define MAIN_MENU_ITEM_11_CONFIRM

  #define MAIN_MENU_ITEM_12_DESC "Z -0,001"
  #define MAIN_MENU_ITEM_12_GCODE "G1 Z-0.001"
  //#define MAIN_MENU_ITEM_12_CONFIRM

  #define MAIN_MENU_ITEM_13_DESC "Z +0,001"
  #define MAIN_MENU_ITEM_13_GCODE "G1 Z+0.001"
  //#define MAIN_MENU_ITEM_13_CONFIRM

  #define MAIN_MENU_ITEM_14_DESC "Home Z"
  #define MAIN_MENU_ITEM_14_GCODE "G28 Z"
  //#define MAIN_MENU_ITEM_14_CONFIRM

    #define MAIN_MENU_ITEM_15_DESC "Home X"
  #define MAIN_MENU_ITEM_15_GCODE "G28 X"
  //#define MAIN_MENU_ITEM_15_CONFIRM

    #define MAIN_MENU_ITEM_16_DESC "Home Y"
  #define MAIN_MENU_ITEM_16_GCODE "G28 Y"
